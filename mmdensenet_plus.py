...
from mdensenet_plus import MDenseNetBackbone, DenseBlock
...
EPS = 1e-12
class MMDenseNetPlus(nn.Module):
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        for band, section in zip(bands, sections):
            net[band] = MDenseNetBackbone(in_channels, num_features, growth_rate, kernel_size, scale=scale, dilated=dilated, norm=norm, nonlinear=nonlinear, depth=depth, eps=eps, freq_bins=section)
